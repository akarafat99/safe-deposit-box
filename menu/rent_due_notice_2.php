...
<body class="bg-1">
    ...
    <div class="header-bg-1">
        <h1>Rent due notice (Post-reminder)</h1>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="#" method="POST" enctype="multipart/form-data">
                            <div class="input-group">
                                ...
                                Total <blank style="font-size: 30px; font-weight: bolder;">' . $found . '</blank> 
                                customer\'s box already expired.<br>Send post reminder email.</label>';
                                echo '</div>';
                                if ($found != 0) {
                                    echo '
...
if (isset($_POST['send_mail'])) {
    $_SESSION['newprepost'] = 2;
    $link->go_mailSend1();
    
}

if(isset($_POST['send_letter'])) {
    $link->go_letterManage2();
}
?>