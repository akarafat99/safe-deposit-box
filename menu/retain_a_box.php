...
<head>
    ...
    <!-- Title Page-->
    <title>First National Bank | Retain a box</title>
                ...
                <div class="card-body">
                    ...
                    <form action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <input class="input--style-4" type="text" name="b_id" required>
                        </div>

                        <div class="p-t-15" style="text-align: center;">
                            <button class="btn btn--radius-2 btn--blue" type="submit" name="retain">Retain box</button>
...
if (isset($_POST['retain'])) {
    ...
    if (mysqli_fetch_assoc($result) > 0) {
        $sql = "DELETE FROM tbl_box WHERE box_id = $_POST[b_id] AND box_owner_id = $_POST[c_id] ";
        $result = mysqli_query($conn, $sql);

        if ($result) {
            $_SESSION["msg"] = 'Box retained.';
        } else {
            $_SESSION["msg"] = 'Box retained failed.';
        }
    } else {
