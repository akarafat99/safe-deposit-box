    ...
    <div id="print-element">
        <div class="sec-1">
            ...
            echo '
                ...
                <p>Dear customer,</p>
                <p>This letter is to remind you that your box will expire after this calender month.
                    Please pay '. $_SESSION['t_box_id'][$_POST["print"]] .'$ within this calender month for uninterrupted service. Thank you.</p>';
            ?>
